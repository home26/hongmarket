  ...
  <div class="order-confirm">
      ...
      <div class="container">
        <div class="order-box">
          <div class="item-address">
            <h2 class="addr-title">Delivery Address</h2>
          ...
          <div class="item-shipping">
            <h2>Delivery Solution</h2>
            <span>Free</span>
          </div>
          <div class="item-invoice">
            <h2>Invoice</h2>
            <a href="javascript:;">Electronic Invoice</a>
            <a href="javascript:;">Personal</a>
          </div>
          <div class="detail">
            <div class="item">
              <span class="item-name">Number of Product:</span>
          ...
          <div class="btn-group">
            ...
            <a href="javascript:;" class="btn btn-large" @click="orderSubmit">Go to pay</a>
          </div>
        </div>
      </div>
    </div>
    ...
    >
      <template v-slot:body>
        <div class="edit-wrap">
          <div class="item">
            <input type="text" class="input" placeholder="Name" v-model="checkedItem.receiverName">
            <input type="text" class="input" placeholder="PhoneNumber" v-model="checkedItem.receiverMobile">
          </div>
          <div class="item">
            ...
            <select name="district" v-model="checkedItem.receiverDistrict">
              <option value="Toronto">York District</option>
              <option value="Calgary">York District</option>
              <option value="Calgary">York District</option>
              <option value="Montreal">York District</option>
              <option value="Calgary">York District</option>
              <option value="Montreal">York District</option>
            </select>
          </div>
          ...
          <div class="item">
            <input type="text" class="input" placeholder="Postal Code" v-model="checkedItem.receiverZip">
          </div>
        </div>
      </template>
    </modal>
...
export default{
  ...
  data(){
    return {
      list:[],//address list
      cartList:[],//items in the cart
      cartTotalPrice:0,//total price
      count:0,
      checkedItem:{},
      userAction:'',//0:add 1:edit 2:delete
      showDelModal:false,
      showEditModal:false,
      checkIndex:0
    }
  ...
  methods:{
    ...
    submitAddress(){
      ...
      if(userAction == 0 || userAction ==1){
        ...
        let errMsg='';
        if(!receiverName){
          errMsg = 'Please enter receiver\'s name';
